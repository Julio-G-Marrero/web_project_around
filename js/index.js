...
const modalCloseImage = document.querySelector(".modal__closeIcon_image");
const modalCloseProfile = document.querySelector(".modal__closeIcon_perfil ");
const modalClosePlace = document.querySelector(".modal__closeIcon_place ");
